...
function schemeUnSubscribe(req,res,next)
{
  Users.findByIdAndUpdate(req.params.userId,{$pull:{activeschemes:req.body.schemeId}},(err,data)=>{
    if(!err){
      // extra user auth
...
module.exports = schemeUnSubscribe;